...
public class FabricQueryServiceImpl implements ServiceQueryCommon<PageDTO<FabricResponse>, FabricSearchRequest> {
    ...
    @Override
    public PageDTO<FabricResponse> search(FabricSearchRequest request) {
        ...
        List<FabricResponse> fabricDTOS = this.fabricMapperDTO.toDTO(fabrics);
