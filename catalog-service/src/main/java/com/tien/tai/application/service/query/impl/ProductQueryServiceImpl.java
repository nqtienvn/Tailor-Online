...
public class ProductQueryServiceImpl implements ServiceQueryCommon<PageDTO<ProductResponse>, ProductSearchRequest> {
    ...
    public PageDTO<ProductResponse> search(ProductSearchRequest request) {
        ...
        List<ProductResponse> productDtos = this.productMapperDTO.toDTO(products);
